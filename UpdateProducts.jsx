...
function UpdateProduct() {
    ...
    function submitHandler(event){
        ...
        axios
          .put("http://localhost:8080/CustomizePlan/products", json, config)
          .then((response) => {
  ...
  return (
    <div className="col-md-6 offset-md-3 card card-body mt-5 coform mb-5" id="co">
      <form name="myForm" onSubmit={submitHandler}>
        <h3 className="mb-5 text-muted text-center mt-5">Update Products</h3>
        ...
        <div>
          <button className="btn btn-primary mt-4 subtn" type="submit">Update Product</button>
        </div>
      </form>
    </div>
  );
